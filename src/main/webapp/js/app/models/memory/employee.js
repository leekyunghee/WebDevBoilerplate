define(function(require) {
	...
	findById = function(id) {
		var deferred = $.Deferred(), employee = null, l = employees.length, i;
		for (i = 0; i < l; i = i + 1) {
	...
	findByName = function(searchKey) {
		var deferred = $.Deferred(), results = employees
	...
	findByManager = function(managerId) {
		var deferred = $.Deferred(), results = employees.filter(function(
				element) {
